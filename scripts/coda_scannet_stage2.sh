...
python main.py --dataset_name scannet_anonymous_aligned_image_with_novel_cate_confi \
...
--dist_url tcp://localhost:16006 \
--checkpoint_dir outputs/coda_scannet_stage2 \
--checkpoint_file outputs/coda_scannet_stage1/last_checkpoint.pth \
