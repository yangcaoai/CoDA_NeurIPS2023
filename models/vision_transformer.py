...
class VisionTwoModalTransformer(nn.Module):
    ...
    def forward_features(self, x, pc_features):
    ...
    def forward(self, image_resized_batch, pc_features):
        x = self.forward_features(image_resized_batch, pc_features)
