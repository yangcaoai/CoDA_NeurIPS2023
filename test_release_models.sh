...
--test_ckpt pretrained_model_codav2_released/scannet/checkpoint_0600.pth \
--batchsize_per_gpu_test 48  \
--log_file ./model_release_scannet50_after_3dnod.lst  \
--if_after_nms --model_name 3detr_predictedbox_distillation_head_globalpool_2dbox  --ngpus 8 --enc_dim 256 --dec_dim 512  \
--train_range_min 0 \
--train_range_max 10 \
--test_range_min 0 \
--test_range_max 60 \
