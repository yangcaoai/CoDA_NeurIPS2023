...
if here_path.find('user-job-dir')!=-1:
    ...
    ALL_SUPERCLASS_PATH = "datasets/sunrgbd_seen_and_obj365_cate_to_idx.npy"
    # ALL_SUPERCLASS_PATH = "datasets/all_classes_trainval_v2_revised_del_val_less_than_5_classes_lvis_combined_1201classes.npy"
    ALL_GLOBAL_OBJECT_PATH = "Data/sunrgb_d/sunrgbd_v1_revised_0415/sunrgbd_pc_bbox_votes_50k_v1_all_classes_revised_0415_noveltrain_global_novel_setting0/"
...
class Sunrgbd3DNODGlobalNovelPoolConfig(object):
...
class Sunrgbd3DNODGlobalNovelPoolDataLayer(Dataset):
    def __init__(
        self,
        dataset_config,
        split_set="train",
