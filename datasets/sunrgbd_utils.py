...
class SUNRGBD_Calibration(object):
    ...
    def __init__(self, calib_filepath, if_tensor=True):
    ...
    def project_upright_depth_to_camera_tensor(self, pc):
        ...
        return flip_axis_to_camera_tensor(torch.transpose(pc2, 0, 1))
...
def project_3dpoint_to_2dpoint_corners_tensor(pc, K_tensor=None, Rtilt_tensor=None, trans_mtx=None):
    ...
    Rtilt_tensor = Rtilt_tensor.unsqueeze(1)
    pc2 = torch.matmul(torch.transpose(Rtilt_tensor, 2, 3), torch.transpose(pc[:, :, :, 0:3], 2, 3))
