...
from utils.box_util import (flip_axis_to_camera_np, flip_axis_to_camera_tensor,
                            get_3d_box_batch_np, get_3d_box_batch_tensor, box3d_iou, get_3d_box_batch_np_xyz, get_3d_box_batch_tensor_xyz)
...
if here_path.find('user-job-dir')!=-1:
    ...
    DATASET_ROOT_DIR = "Data/3d_indoor/scannet/scannet_frames_25k/make_data_scannet200_cluster/scannet_frames_25k_200cls_train"
    DATASET_PARAMS_DIR = "Data/3d_indoor/scannet/scannet_frames_25k/make_data_scannet200_cluster/matrix"
...
class Scannet50ImageDatasetConfig(object):
    def __init__(self, if_print=False, args=None):
        self.num_angle_bin = 12
        self.max_num_obj = 64
        self.reset_scannet_num = args.reset_scannet_num
        if args != None:
            print('===============reset_cannet_num=================')
            print(self.reset_scannet_num)
            self.num_semcls = len(args.train_range_list) + self.reset_scannet_num
            ...
            for tmp_class_id in args.test_range_list:
                ...
                tmp_cnt += 1
                if tmp_cnt >= self.reset_scannet_num:
                    break

            self.test_range_list = sorted(tmp_test_range_list)

        self.class_id_to_idx = {}
        for idx_tmp, class_id_tmp in enumerate(self.test_range_list):
            self.class_id_to_idx[class_id_tmp] = idx_tmp
        ...
        # }
        self.class2type = {}
        for t in self.type2class:
            if self.type2class[t] in self.class_id_to_idx.keys():
                self.class2type[self.class_id_to_idx[self.type2class[t]]] = t
        if args != None:
    ...
    def box_parametrization_to_corners(self, box_center_unnorm, box_size, box_angle):
        ...
        # boxes = get_3d_box_batch_tensor(box_size, -1 * box_angle, box_center_upright)
        # print('add -1 * for debugging in scannet_anonymous.py')
        return boxes
    ...
    def box_parametrization_to_corners_np(self, box_center_unnorm, box_size, box_angle):
        ...
        # boxes = get_3d_box_batch_np(box_size, -1 * box_angle, box_center_upright)  # waiting for debuging
        # print('add -1 * for debugging in scannet_anonymous.py')
        return boxes
...
class Scannet50DetectionImageDataset(Dataset):
    def __init__(
        self,
        dataset_config,
        split_set="train",
        ...
        print(split_set)
        assert split_set in ["train", "val", "minival", "test", "minitest", "real_test", "real_cmp_test", "chairval"]
        if root_dir is None:
        ...
        if split_set in ["train", "val", "minival", "test", "minitest", "real_test", "real_cmp_test", "chairval"]:
        ...
