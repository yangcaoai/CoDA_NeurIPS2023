...
class ScannetImageDatasetConfig(object):
    def __init__(self, if_print=False, args=None):
        ...
        self.eval_class2type = self.class2type.copy()
        if args != None:
...
class ScannetDetectionImageDataset(Dataset):
    def __init__(
        self,
        dataset_config,
        split_set="train",
