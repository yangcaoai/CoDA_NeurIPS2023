...
from utils.box_util import (flip_axis_to_camera_np, flip_axis_to_camera_tensor,
                            get_3d_box_batch_np, get_3d_box_batch_tensor, box3d_iou, get_3d_box_batch_np_xyz)
...
class ScannetImageCmpDatasetConfig(object):
    def __init__(self, if_print=False, args=None):
        self.num_semcls = 19
        self.num_angle_bin = 12
        self.max_num_obj = 64
        self.class_id_to_idx = {17: 0, 11: 1, 2: 2, 36: 3, 4: 4, 7: 5, 18: 6, 13: 7, 14: 8, 42: 9, 27: 10, 9: 11, 34: 12, 35: 13, 5: 14, 21: 15, 26: 16, 28: 17, 47: 18}
        ...
        self.test_range_list = [17, 11, 2, 36, 4, 7, 18, 13, 14, 42, 27, 9, 34, 35, 5, 21, 26, 28, 47] #args.test_range_list
    ...
    def box_parametrization_to_corners_np_xyz(self, box_center_unnorm, box_size, box_angle):
        # box_center_upright = flip_axis_to_camera_np(box_center_unnorm)
        boxes = get_3d_box_batch_np(box_size, -1 * box_angle, box_center_unnorm)
        return boxes
...
class ScannetDetectionImageCmpDataset(Dataset):
    def __init__(
        self,
        dataset_config,
        split_set="train",
